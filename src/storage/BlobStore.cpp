...
std::string BlobStore::compressData(const std::string& data) {
    return utils::zlibCompress(data);
}
...
bool BlobStore::blobExists(uint64_t id) {
    return findBlobEntryOffset(id) != 0;
}
