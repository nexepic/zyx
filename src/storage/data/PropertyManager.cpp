...
PropertyManager::PropertyManager(std::shared_ptr<DataManager> dataManager)
    : dataManager_(dataManager) {
}

uint32_t PropertyManager::calculateSerializedSize(
...
std::unordered_map<std::string, PropertyValue> PropertyManager::deserializeProperties(std::istream& is) const {
...
template<typename EntityType>
void PropertyManager::storePropertiesInPropertyEntity(EntityType& entity,
    ...
    EntityPropertyTraits<EntityType>::setPropertyEntityId(entity, property.getId(), PropertyStorageType::PROPERTY_ENTITY);
...
void PropertyManager::storePropertiesInBlob(EntityType& entity,
    ...
    try {
        ...
        EntityPropertyTraits<EntityType>::setPropertyEntityId(entity, blobChain[0].getId(), PropertyStorageType::BLOB_ENTITY);
...
std::unordered_map<std::string, PropertyValue> PropertyManager::getPropertiesFromBlob(int64_t blobId) {
    auto dataManager = dataManager_.lock();
    if (!dataManager) return {};
...
std::unordered_map<std::string, PropertyValue> PropertyManager::getEntityProperties(int64_t entityId) {
    ...
    auto dataManager = dataManager_.lock();
    if (!dataManager) return allProperties;
            ...
            if (storageType == PropertyStorageType::PROPERTY_ENTITY) {
                ...
                if (property.getId() != 0 && property.isActive()) {
                    ...
                    if (property.getEntityId() == entityId &&
                        property.getEntityType() == EntityType::typeId) {
                        // Merge properties
...
size_t PropertyManager::calculateEntityTotalPropertySize(int64_t entityId) {
    ...
    EntityType entity = dataManager->getEntity<EntityType>(entityId);
    if (entity.getId() == 0 || !entity.isActive()) {
        return 0;
    }
...
template void PropertyManager::storePropertiesInPropertyEntity<Node>(Node& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInPropertyEntity<Edge>(Edge& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInPropertyEntity<Property>(Property& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInPropertyEntity<Blob>(Blob& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInPropertyEntity<Index>(Index& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInPropertyEntity<State>(State& entity, const std::unordered_map<std::string, PropertyValue>&);

// storePropertiesInBlob instantiations
template void PropertyManager::storePropertiesInBlob<Node>(Node& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInBlob<Edge>(Edge& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInBlob<Property>(Property& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInBlob<Blob>(Blob& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInBlob<Index>(Index& entity, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::storePropertiesInBlob<State>(State& entity, const std::unordered_map<std::string, PropertyValue>&);

// getEntityProperties instantiations
template std::unordered_map<std::string, PropertyValue> PropertyManager::getEntityProperties<Node>(int64_t entityId);
template std::unordered_map<std::string, PropertyValue> PropertyManager::getEntityProperties<Edge>(int64_t entityId);
template std::unordered_map<std::string, PropertyValue> PropertyManager::getEntityProperties<Property>(int64_t entityId);
template std::unordered_map<std::string, PropertyValue> PropertyManager::getEntityProperties<Blob>(int64_t entityId);
template std::unordered_map<std::string, PropertyValue> PropertyManager::getEntityProperties<Index>(int64_t entityId);
template std::unordered_map<std::string, PropertyValue> PropertyManager::getEntityProperties<State>(int64_t entityId);

// addEntityProperties instantiations
template void PropertyManager::addEntityProperties<Node>(int64_t entityId, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::addEntityProperties<Edge>(int64_t entityId, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::addEntityProperties<Property>(int64_t entityId, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::addEntityProperties<Blob>(int64_t entityId, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::addEntityProperties<Index>(int64_t entityId, const std::unordered_map<std::string, PropertyValue>&);
template void PropertyManager::addEntityProperties<State>(int64_t entityId, const std::unordered_map<std::string, PropertyValue>&);
