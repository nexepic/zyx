/**
 * @file TypeConversionFunctions.cpp
...
void registerTypeConversionFunctions(FunctionRegistry& registry) {
	registry.registerFunction(makeFn("toInteger", 1, 1, &toIntegerImpl));
	registry.registerFunction(makeFn("toFloat", 1, 1, &toFloatImpl));
	registry.registerFunction(makeFn("toBoolean", 1, 1, &toBooleanImpl));
}
