...
QueryPlan QueryPlanner::createPlanForLabelAndPropertyQuery(const std::string& label,
...
QueryPlan QueryPlanner::createPlanForPropertyRangeQuery(const std::string& key,
                                                     double minValue,
                                                     double maxValue) {
...
QueryPlan QueryPlanner::createPlanForTextSearchQuery(const std::string& key,
...
QueryPlan QueryPlanner::createPlanForRelationshipQuery(uint64_t nodeId,
...
QueryPlan QueryPlanner::createPlanForConnectedNodesQuery(uint64_t nodeId,
                                                      const std::string& edgeLabel,
