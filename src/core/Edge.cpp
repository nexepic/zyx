...
namespace graph {
	...
	Edge::Edge(int64_t id, int64_t from, int64_t to, std::string label) :
	...
	int64_t Edge::getFromNodeId() const { return fromNodeId; }

	int64_t Edge::getToNodeId() const { return toNodeId; }
	...
	const PropertyReference &Edge::getPropertyReference() const { return propertyRef; }
