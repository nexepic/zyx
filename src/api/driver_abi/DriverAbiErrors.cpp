...
const zyx_driver_error_t &staticErrorFor(zyx_driver_status_t code) noexcept { // ZYX_COV_EXCL_FUNCTION: fallback for error allocation failure.
    static const zyx_driver_error_t ok{ZYX_DRIVER_OK, {}, "", true};
    static const zyx_driver_error_t invalidArgument{ZYX_DRIVER_INVALID_ARGUMENT, {}, "invalid argument", true};
    static const zyx_driver_error_t outOfRange{ZYX_DRIVER_OUT_OF_RANGE, {}, "out of range", true};
    static const zyx_driver_error_t typeMismatch{ZYX_DRIVER_TYPE_MISMATCH, {}, "type mismatch", true};
    static const zyx_driver_error_t notFound{ZYX_DRIVER_NOT_FOUND, {}, "not found", true};
    static const zyx_driver_error_t openFailed{ZYX_DRIVER_OPEN_FAILED, {}, "open failed", true};
    static const zyx_driver_error_t parseError{ZYX_DRIVER_PARSE_ERROR, {}, "parse error", true};
    static const zyx_driver_error_t executionError{ZYX_DRIVER_EXECUTION_ERROR, {}, "execution error", true};
    static const zyx_driver_error_t transactionError{ZYX_DRIVER_TRANSACTION_ERROR, {}, "transaction error", true};
    static const zyx_driver_error_t readOnlyViolation{ZYX_DRIVER_READ_ONLY_VIOLATION, {}, "read-only violation", true};
    static const zyx_driver_error_t ioError{ZYX_DRIVER_IO_ERROR, {}, "I/O error", true};
    static const zyx_driver_error_t outOfMemory{ZYX_DRIVER_OUT_OF_MEMORY, {}, "out of memory", true};
    static const zyx_driver_error_t internalError{ZYX_DRIVER_INTERNAL_ERROR, {}, "internal error", true};
...
zyx_driver_status_t setError(zyx_driver_error_t **out_error, zyx_driver_status_t code, const char *message) noexcept {
    try {
        if (out_error != nullptr) {
            *out_error = new zyx_driver_error_t{code, std::string(message != nullptr ? message : ""), nullptr, false};
        }
...
zyx_driver_status_t setError(zyx_driver_error_t **out_error, zyx_driver_status_t code, std::string message) noexcept {
    try {
        if (out_error != nullptr) {
            *out_error = new zyx_driver_error_t{code, std::move(message), nullptr, false};
        }
    } catch (...) { // ZYX_COV_EXCL_LINE: fallback for error-reporting allocation failure.
        setStaticError(out_error, code);
    }
