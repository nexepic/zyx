/**
 * @file test_CApi_FloatListBranches.cpp
...
class CApiFloatListBranchTest : public ::testing::Test {
protected:
	std::string dbPath;
	ZYXDB_T *db = nullptr;
...
TEST_F(CApiFloatListBranchTest, NumericLiteralListsUseStableStringListSemantics) {
