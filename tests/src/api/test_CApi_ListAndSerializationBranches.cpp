/**
 * @file test_CApi_ListAndSerializationBranches.cpp
...
class CApiListSerializationTest : public ::testing::Test {
protected:
	std::string dbPath;
	ZYXDB_T *db = nullptr;
...
TEST_F(CApiListSerializationTest, PropsJsonEscapesControlCharsAndUsesComplexPlaceholder) {
...
TEST_F(CApiListSerializationTest, ListAndMapAccessCoverFloatStringAndBoundsBranches) {
...
TEST_F(CApiListSerializationTest, AccessorsFallbackOnInvalidColumnIndex) {
