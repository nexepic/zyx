/**
 * @file test_CypherToPlanVisitor_ControlFlow.cpp
...
class CypherToPlanVisitorControlFlowTest : public ::testing::Test {
protected:
...
TEST_F(CypherToPlanVisitorControlFlowTest, GetPlanAndLogicalPlanReturnNullWhenRootIsMissing) {
...
TEST_F(CypherToPlanVisitorControlFlowTest, VisitTxnBeginBuildsTransactionControlPlan) {
	graph::parser::cypher::CypherToPlanVisitor visitor(planner);
...
TEST_F(CypherToPlanVisitorControlFlowTest, VisitTxnRollbackBuildsTransactionControlPlan) {
	graph::parser::cypher::CypherToPlanVisitor visitor(planner);
