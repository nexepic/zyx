...
TEST_F(WithClauseHandlerUnitTest, With_Star) {
...
TEST_F(WithClauseHandlerUnitTest, With_Distinct) {
	// Test WITH DISTINCT
...
TEST_F(WithClauseHandlerUnitTest, With_MultipleProjections) {
...
TEST_F(WithClauseHandlerUnitTest, With_WithAlias) {
...
TEST_F(WithClauseHandlerUnitTest, With_WithoutAlias) {
...
TEST_F(WithClauseHandlerUnitTest, With_AfterMatch) {
...
TEST_F(WithClauseHandlerUnitTest, With_BeforeCreate) {
