...
class NodeDistinctCountFastPathOperatorTest : public ::testing::Test {
protected:
...
TEST_F(NodeDistinctCountFastPathOperatorTest, CountsDistinctSelectedPropertyValues) {
	...
	NodeDistinctCountFastPathOperator op(dm, im, config, requirements, {}, "country", "count");
	op.open();
	auto batch = op.next();
...
TEST_F(NodeDistinctCountFastPathOperatorTest, SkipsRedundantChecksForLabelIndexCandidates) {
...
TEST_F(NodeDistinctCountFastPathOperatorTest, AppliesResidualPropertyPredicatesBeforeDistinctCount) {
	...
	NodeDistinctCountFastPathOperator op(dm, im, config, requirements, {predicate}, "country", "count");
	op.open();
	auto batch = op.next();
