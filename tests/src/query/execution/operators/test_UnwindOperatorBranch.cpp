/**
 * @file test_UnwindOperatorBranch.cpp
 * @date 2026/03/21
 *
...
class UnwindOperatorBranchTest : public ::testing::Test {};

// Test: Source mode with large list exceeding DEFAULT_BATCH_SIZE
// This exercises the while loop batch boundary in Case A
TEST_F(UnwindOperatorBranchTest, SourceMode_LargeListExceedsBatchSize) {
...
TEST_F(UnwindOperatorBranchTest, PipelineMode_LargeListPerRecord) {
	Record r1;
...
TEST_F(UnwindOperatorBranchTest, PipelineMode_LiteralListMultipleRecords) {
	Record r1, r2, r3;
	r1.setValue("n", int64_t(1));
...
TEST_F(UnwindOperatorBranchTest, PipelineMode_UpstreamExhaustedWithPartialOutput) {
	Record r1;
...
TEST_F(UnwindOperatorBranchTest, PipelineMode_ExpressionMultipleBatches) {
	Record r1, r2;
	r1.setValue("n", int64_t(1));
	r2.setValue("n", int64_t(2));
...
TEST_F(UnwindOperatorBranchTest, SourceMode_ExpressionSecondCallReturnsNullopt) {
...
TEST_F(UnwindOperatorBranchTest, SourceMode_LiteralReopen) {
...
TEST_F(UnwindOperatorBranchTest, PipelineMode_TransitionBetweenBatches) {
	Record r1, r2;
	r1.setValue("n", int64_t(1));
	r2.setValue("n", int64_t(2));
