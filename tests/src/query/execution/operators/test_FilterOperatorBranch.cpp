/**
 * @file test_FilterOperatorBranch.cpp
...
class FilterOperatorBranchTest : public ::testing::Test {};

// ============================================================================
// Expression-based filter (filterExpr_ path in evaluateRecord)
// ============================================================================

TEST_F(FilterOperatorBranchTest, ExpressionFilter_BasicComparison) {
...
TEST_F(FilterOperatorBranchTest, ExpressionFilter_AllFiltered) {
...
TEST_F(FilterOperatorBranchTest, ExpressionFilter_WithQueryContext) {
	auto expr = std::make_shared<graph::query::expressions::LiteralExpression>(true);
...
TEST_F(FilterOperatorBranchTest, ExpressionFilter_WithEmptyQueryContext) {
...
TEST_F(FilterOperatorBranchTest, PredicateFilter_Basic) {
	Record r1, r2, r3;
	r1.setValue("x", PropertyValue(static_cast<int64_t>(1)));
...
TEST_F(FilterOperatorBranchTest, ParallelFilter_LargeDataset) {
...
TEST_F(FilterOperatorBranchTest, SingleThreadedPool_FallsBackToSequential) {
...
TEST_F(FilterOperatorBranchTest, OpenCloseWithNullChild) {
...
TEST_F(FilterOperatorBranchTest, GetOutputVariables_NullChild) {
	auto predicate = [](const Record &) { return true; };
	auto op = std::make_unique<FilterOperator>(nullptr, predicate, "true");
...
TEST_F(FilterOperatorBranchTest, GetChildren_NullChild) {
	auto predicate = [](const Record &) { return true; };
	auto op = std::make_unique<FilterOperator>(nullptr, predicate, "true");
...
TEST_F(FilterOperatorBranchTest, GetChildren_WithChild) {
	Record r;
...
TEST_F(FilterOperatorBranchTest, ToString) {
	auto predicate = [](const Record &) { return true; };
...
TEST_F(FilterOperatorBranchTest, MultipleBatches_SkipsEmptyFiltered) {
	Record r1, r2, r3;
	r1.setValue("x", PropertyValue(static_cast<int64_t>(1)));
