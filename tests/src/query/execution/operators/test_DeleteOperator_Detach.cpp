/**
 * @file test_DeleteOperator_Detach.cpp
 * @date 2026/03/21
 *
...
class DeleteOperatorDetachTest : public ::testing::Test {
protected:
...
TEST_F(DeleteOperatorDetachTest, ChildExhaustedImmediately) {
...
TEST_F(DeleteOperatorDetachTest, DeleteNode_NoRelationships) {
...
TEST_F(DeleteOperatorDetachTest, DeleteNode_WithRelationships_NonDetach_Throws) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	Node n2(0, labelId);
	dm->addNode(n1);
...
TEST_F(DeleteOperatorDetachTest, DetachDeleteNode_WithRelationships) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	Node n2(0, labelId);
	dm->addNode(n1);
...
// Delete an edge
TEST_F(DeleteOperatorDetachTest, DeleteEdge) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	Node n2(0, labelId);
	dm->addNode(n1);
...
TEST_F(DeleteOperatorDetachTest, VariableNotBound) {
	Record r1;
...
TEST_F(DeleteOperatorDetachTest, MultipleVariables) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	Node n2(0, labelId);
	dm->addNode(n1);
...
TEST_F(DeleteOperatorDetachTest, ToString_NonDetach) {
	auto mock = std::make_unique<DeleteMockChild>();
	auto op = std::make_unique<DeleteOperator>(dm, std::move(mock), std::vector<std::string>{"n"}, false);
	EXPECT_EQ(op->toString(), "Delete(n)");
}

TEST_F(DeleteOperatorDetachTest, ToString_Detach) {
	auto mock = std::make_unique<DeleteMockChild>();
	auto op = std::make_unique<DeleteOperator>(dm, std::move(mock), std::vector<std::string>{"n"}, true);
	EXPECT_EQ(op->toString(), "DetachDelete(n)");
}

TEST_F(DeleteOperatorDetachTest, ToString_MultipleVariables) {
	auto mock = std::make_unique<DeleteMockChild>();
...
TEST_F(DeleteOperatorDetachTest, GetChildrenAndOutputVars) {
	auto mock = std::make_unique<DeleteMockChild>();
...
TEST_F(DeleteOperatorDetachTest, OpenClose_NullChild) {
...
TEST_F(DeleteOperatorDetachTest, DetachDeleteNode_NoRelationships) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	dm->addNode(n1);
...
TEST_F(DeleteOperatorDetachTest, DetachDeleteNode_MultipleRelationships) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	Node n2(0, labelId);
	Node n3(0, labelId);
...
TEST_F(DeleteOperatorDetachTest, MultipleRecordsInBatch) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	Node n2(0, labelId);
	Node n3(0, labelId);
...
TEST_F(DeleteOperatorDetachTest, ToString_SingleVariable) {
	auto mock = std::make_unique<DeleteMockChild>();
...
TEST_F(DeleteOperatorDetachTest, ToString_TwoVariables) {
	auto mock = std::make_unique<DeleteMockChild>();
