/**
 * @file test_NodeScanOperator_ScanModes.cpp
 * @date 2026/03/21
 *
...
class NodeScanOperatorScanModesTest : public ::testing::Test {
protected:
...
TEST_F(NodeScanOperatorScanModesTest, FullScan_NoNodes) {
...
TEST_F(NodeScanOperatorScanModesTest, FullScan_ActiveNodes) {
...
TEST_F(NodeScanOperatorScanModesTest, FullScan_WithLabelFilter) {
...
TEST_F(NodeScanOperatorScanModesTest, FullScan_EmptyLabel) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	dm->addNode(n1);
...
TEST_F(NodeScanOperatorScanModesTest, FullScan_InactiveNodeSkipped) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	Node n2(0, labelId);
	dm->addNode(n1);
...
TEST_F(NodeScanOperatorScanModesTest, LabelScan) {
	int64_t personLabel = dm->getOrCreateTokenId("Person");
	Node n1(0, personLabel);
	dm->addNode(n1);
...
TEST_F(NodeScanOperatorScanModesTest, LabelScan_NoMatches) {
	NodeScanConfig config;
	config.type = ScanType::LABEL_SCAN;
	config.variable = "n";
...
// getOutputVariables
TEST_F(NodeScanOperatorScanModesTest, GetOutputVariables) {
	NodeScanConfig config;
...
TEST_F(NodeScanOperatorScanModesTest, ToString_FullScan) {
	NodeScanConfig config;
	config.type = ScanType::FULL_SCAN;
	config.variable = "n";
...
TEST_F(NodeScanOperatorScanModesTest, ToString_LabelScan) {
	NodeScanConfig config;
	config.type = ScanType::LABEL_SCAN;
	config.variable = "n";
	config.labels = {"Person"};
...
TEST_F(NodeScanOperatorScanModesTest, ToString_PropertyScan) {
	NodeScanConfig config;
...
// Property scan
TEST_F(NodeScanOperatorScanModesTest, PropertyScan) {
	int64_t personLabel = dm->getOrCreateTokenId("Person");
	Node n1(0, personLabel);
	dm->addNode(n1);
...
TEST_F(NodeScanOperatorScanModesTest, PropertyScan_NoMatches) {
	NodeScanConfig config;
	config.type = ScanType::PROPERTY_SCAN;
	config.variable = "n";
	config.labels = {"Person"};
...
TEST_F(NodeScanOperatorScanModesTest, AllNodesDeleted) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	dm->addNode(n1);
...
TEST_F(NodeScanOperatorScanModesTest, InvalidScanTypeFallsBackToFullScan) {
	int64_t labelId = dm->getOrCreateTokenId("Person");
	Node n1(0, labelId);
	dm->addNode(n1);
