/**
 * @file test_CreateNodeOperator_Pipeline.cpp
 * @date 2026/03/21
 *
...
class CreateNodeOperatorPipelineTest : public ::testing::Test {
protected:
...
TEST_F(CreateNodeOperatorPipelineTest, SourceMode_BasicCreate) {
...
TEST_F(CreateNodeOperatorPipelineTest, SourceMode_CreateWithProperties) {
...
TEST_F(CreateNodeOperatorPipelineTest, SourceMode_EmptyProperties) {
	std::unordered_map<std::string, PropertyValue> emptyProps;
	auto op = std::make_unique<CreateNodeOperator>(dm, "n", std::vector<std::string>{"Person"}, emptyProps);
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_UnboundVariable) {
	Record r1;
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_ChildReturnsEmptyBatch) {
	Record r1;
	r1.setValue("x", int64_t(1));
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_ChildExhaustedImmediately) {
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_ExistingNodeBound) {
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_ExistingNodeWithPendingBuffer) {
	Node existingNode(1, 100);
	dm->addNode(existingNode);
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_ChildExhaustedSecondCall) {
	Record r1;
	r1.setValue("x", int64_t(1));
...
TEST_F(CreateNodeOperatorPipelineTest, GetOutputVariables_WithChild) {
	auto mock = std::make_unique<CreateNodeMockChild>();
	std::unordered_map<std::string, PropertyValue> emptyProps;
	auto op = std::make_unique<CreateNodeOperator>(dm, "n", std::vector<std::string>{"Person"}, emptyProps);
	op->setChild(std::move(mock));
...
TEST_F(CreateNodeOperatorPipelineTest, GetOutputVariables_NoChild) {
	std::unordered_map<std::string, PropertyValue> emptyProps;
	auto op = std::make_unique<CreateNodeOperator>(dm, "n", std::vector<std::string>{"Person"}, emptyProps);
...
TEST_F(CreateNodeOperatorPipelineTest, GetOutputVariables_DifferentVariable) {
	auto mock = std::make_unique<CreateNodeMockChild>();
...
// Metadata: toString
TEST_F(CreateNodeOperatorPipelineTest, ToString) {
	std::unordered_map<std::string, PropertyValue> emptyProps;
	auto op = std::make_unique<CreateNodeOperator>(dm, "n", std::vector<std::string>{"Person"}, emptyProps);
...
TEST_F(CreateNodeOperatorPipelineTest, GetChildren) {
	std::unordered_map<std::string, PropertyValue> emptyProps;
...
TEST_F(CreateNodeOperatorPipelineTest, OpenCloseWithChild) {
	auto mock = std::make_unique<CreateNodeMockChild>();
	std::unordered_map<std::string, PropertyValue> emptyProps;
	auto op = std::make_unique<CreateNodeOperator>(dm, "n", std::vector<std::string>{"Person"}, emptyProps);
	op->setChild(std::move(mock));
...
TEST_F(CreateNodeOperatorPipelineTest, OpenCloseWithoutChild) {
	std::unordered_map<std::string, PropertyValue> emptyProps;
	auto op = std::make_unique<CreateNodeOperator>(dm, "n", std::vector<std::string>{"Person"}, emptyProps);
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_BatchSizeThresholdFlush) {
...
TEST_F(CreateNodeOperatorPipelineTest, SourceMode_PerformSingleCreate_WithProps) {
	std::unordered_map<std::string, PropertyValue> props = {
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_MultipleEmptyBatches) {
...
TEST_F(CreateNodeOperatorPipelineTest, PipelineMode_WithProperties) {
	Record r1;
	r1.setValue("x", int64_t(1));
