/**
 * @file test_CreateEdgeOperator_Pipeline.cpp
 * @date 2026/03/21
 *
...
class CreateEdgeOperatorPipelineTest : public ::testing::Test {
protected:
...
TEST_F(CreateEdgeOperatorPipelineTest, NoChild_ReturnsNullopt) {
...
TEST_F(CreateEdgeOperatorPipelineTest, ChildExhausted_ReturnsNullopt) {
...
TEST_F(CreateEdgeOperatorPipelineTest, BothNodesPresent_EdgeCreated) {
...
TEST_F(CreateEdgeOperatorPipelineTest, SourceMissing_NoEdge) {
	Node n2(0, dm->getOrCreateTokenId("Person"));
	dm->addNode(n2);
...
TEST_F(CreateEdgeOperatorPipelineTest, TargetMissing_NoEdge) {
	Node n1(0, dm->getOrCreateTokenId("Person"));
	dm->addNode(n1);
...
TEST_F(CreateEdgeOperatorPipelineTest, WithProperties) {
	Node n1(0, dm->getOrCreateTokenId("Person"));
	Node n2(0, dm->getOrCreateTokenId("Person"));
	dm->addNode(n1);
	dm->addNode(n2);
...
TEST_F(CreateEdgeOperatorPipelineTest, WithoutProperties) {
	Node n1(0, dm->getOrCreateTokenId("Person"));
	Node n2(0, dm->getOrCreateTokenId("Person"));
	dm->addNode(n1);
	dm->addNode(n2);
...
TEST_F(CreateEdgeOperatorPipelineTest, GetOutputVariables_Dedup) {
	auto mock = std::make_unique<EdgeMockChild>(
...
TEST_F(CreateEdgeOperatorPipelineTest, GetOutputVariables_NoDedup) {
	auto mock = std::make_unique<EdgeMockChild>(
...
TEST_F(CreateEdgeOperatorPipelineTest, GetOutputVariables_NoChild) {
	std::unordered_map<std::string, PropertyValue> props;
	auto op = std::make_unique<CreateEdgeOperator>(dm, "e", "LINK", props, "a", "b");
...
// toString
TEST_F(CreateEdgeOperatorPipelineTest, ToString) {
	std::unordered_map<std::string, PropertyValue> props;
	auto op = std::make_unique<CreateEdgeOperator>(dm, "e", "LINK", props, "a", "b");
...
TEST_F(CreateEdgeOperatorPipelineTest, GetChildren) {
	std::unordered_map<std::string, PropertyValue> props;
...
TEST_F(CreateEdgeOperatorPipelineTest, OpenClose_NullChild) {
	std::unordered_map<std::string, PropertyValue> props;
	auto op = std::make_unique<CreateEdgeOperator>(dm, "e", "LINK", props, "a", "b");
...
TEST_F(CreateEdgeOperatorPipelineTest, MixedRecords) {
	Node n1(0, dm->getOrCreateTokenId("Person"));
	Node n2(0, dm->getOrCreateTokenId("Person"));
	dm->addNode(n1);
	dm->addNode(n2);
...
TEST_F(CreateEdgeOperatorPipelineTest, BothEndpointsMissing_NoEdge) {
	Record r1;
...
TEST_F(CreateEdgeOperatorPipelineTest, MultipleBatches) {
	Node n1(0, dm->getOrCreateTokenId("Person"));
	Node n2(0, dm->getOrCreateTokenId("Person"));
	dm->addNode(n1);
	dm->addNode(n2);
...
TEST_F(CreateEdgeOperatorPipelineTest, ChildReturnsEmptyBatchThenReal) {
	Node n1(0, dm->getOrCreateTokenId("Person"));
	Node n2(0, dm->getOrCreateTokenId("Person"));
	dm->addNode(n1);
	dm->addNode(n2);
...
TEST_F(CreateEdgeOperatorPipelineTest, OpenClosePropagates) {
	auto mock = std::make_unique<EdgeMockChild>();
	std::unordered_map<std::string, PropertyValue> props;
	auto op = std::make_unique<CreateEdgeOperator>(dm, "e", "LINK", props, "a", "b");
	op->setChild(std::move(mock));
