/**
 * @file test_FilterPushdownRuleBranches.cpp
...
class FilterPushdownRuleBranchesTest : public ::testing::Test {
protected:
    rules::FilterPushdownRule rule;
    Statistics stats;
};

TEST_F(FilterPushdownRuleBranchesTest, NullChildFilterIsReturnedAsIs) {
...
TEST_F(FilterPushdownRuleBranchesTest, ProjectWithoutGrandChildCannotBePushedThrough) {
...
TEST_F(FilterPushdownRuleBranchesTest, ReversedEqualityLiteralEqualsPropertyPushesIntoScan) {
...
TEST_F(FilterPushdownRuleBranchesTest, DuplicateEqualityKeyDoesNotDuplicatePredicate) {
...
TEST_F(FilterPushdownRuleBranchesTest, EqualityWithoutPropertyAccessDoesNotPush) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(FilterPushdownRuleBranchesTest, EqualityWithNullOperandIsRejected) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(FilterPushdownRuleBranchesTest, RangeRejectsNullAndBooleanLiterals) {
...
TEST_F(FilterPushdownRuleBranchesTest, ReversedRangeOperatorsAreMappedAndPushed) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(FilterPushdownRuleBranchesTest, DoubleRangeUsesDoublePropertyValueBranch) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(FilterPushdownRuleBranchesTest, JoinPushdownCollectsVarsFromUnaryAndIsNull) {
...
TEST_F(FilterPushdownRuleBranchesTest, JoinPushdownCollectsVarsFromInList) {
    auto left = std::make_unique<LogicalNodeScan>("n");
    auto right = std::make_unique<LogicalNodeScan>("m");
    auto join = std::make_unique<LogicalJoin>(std::move(left), std::move(right));
