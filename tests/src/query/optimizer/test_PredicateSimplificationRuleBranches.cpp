/**
 * @file test_PredicateSimplificationRuleBranches.cpp
...
class PredicateSimplificationRuleBranchesTest : public ::testing::Test {
protected:
    rules::PredicateSimplificationRule rule;
    Statistics stats;
};

TEST_F(PredicateSimplificationRuleBranchesTest, NullPredicateAndNullChildStayStable) {
...
TEST_F(PredicateSimplificationRuleBranchesTest, UnaryMinusIsNotSimplifiedAway) {
...
TEST_F(PredicateSimplificationRuleBranchesTest, SingleNotIsPreserved) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(PredicateSimplificationRuleBranchesTest, XAndFalseSimplifiesToFalseLiteral) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(PredicateSimplificationRuleBranchesTest, XAndTrueSimplifiesToX) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(PredicateSimplificationRuleBranchesTest, TrueOrXAndXOrTrueSimplifyToTrue) {
...
TEST_F(PredicateSimplificationRuleBranchesTest, FalseOrXAndXOrFalseSimplifyToX) {
    auto scan1 = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(PredicateSimplificationRuleBranchesTest, NonBooleanLiteralIsNotFoldedAsLogicalLiteral) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(PredicateSimplificationRuleBranchesTest, FalseLiteralFilterIsNotDropped) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(PredicateSimplificationRuleBranchesTest, NullOperandInBinaryPredicateDoesNotCrash) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
...
TEST_F(PredicateSimplificationRuleBranchesTest, ChildFilterWithNullPredicateDoesNotMerge) {
    auto scan = std::make_unique<LogicalNodeScan>("n");
