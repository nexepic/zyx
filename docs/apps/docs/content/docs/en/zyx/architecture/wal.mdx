...
description: ZYX uses Write-Ahead Logging (WAL) to ensure ACID transaction durability and enable crash recovery.
...
- [Segment Format](/en/docs/zyx/architecture/segment-format) - Data storage format
- [Transaction System](/en/docs/zyx/architecture/transactions) - Transaction management
