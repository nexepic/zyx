---
title: Benchmarks
description: This document presents performance benchmarks for ZYX graph database across various workloads and scenarios.
...
- [Optimization Strategies](/en/docs/zyx/architecture/optimization) - Performance tuning guide
- [Cache Management](/en/docs/zyx/architecture/cache) - Cache optimization
- [Storage System](/en/docs/zyx/architecture/storage) - Storage architecture
