...
description: ZYX provides full ACID transaction support with optimistic concurrency control and comprehensive rollback capabilities.
...
- [Storage System](/en/docs/zyx/architecture/storage) - How transactions persist data
- [Query Engine](/en/docs/zyx/architecture/query-engine) - Query execution in transactions
- [API Reference](/en/docs/zyx/api/cpp-api) - Transaction API usage
