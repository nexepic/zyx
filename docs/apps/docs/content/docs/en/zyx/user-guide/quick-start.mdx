...
- Or follow the [Installation Guide](/en/docs/zyx/contributing/installation)
:::
...
::: tip Learning Path
1. **[Basic Operations](/en/docs/zyx/user-guide/basic-operations)** - Deep dive into CRUD operations
2. **[Transaction Control](/en/docs/zyx/user-guide/transactions)** - Advanced transaction management
3. **[Advanced Queries](/en/docs/zyx/user-guide/advanced-queries)** - Master complex query techniques
4. **[API Reference](/en/docs/zyx/api/cpp-api)** - Embed ZYX in your application
:::
