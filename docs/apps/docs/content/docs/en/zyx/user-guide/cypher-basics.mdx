...
- Learn about [Advanced Queries](/en/docs/zyx/user-guide/advanced-queries)
- Explore [Pattern Matching](/en/docs/zyx/user-guide/pattern-matching)
- Understand [Transaction Control](/en/docs/zyx/user-guide/transactions)
