...
description: Pattern matching is the heart of Cypher, allowing you to express complex graph patterns and traverse relationships efficiently. This guide dives deep 
...
- Learn [Advanced Queries](/en/docs/zyx/user-guide/advanced-queries) for more complex operations
- Understand [Transaction Control](/en/docs/zyx/user-guide/transactions) for data consistency
- Explore [Batch Operations](/en/docs/zyx/user-guide/batch-operations) for bulk processing
