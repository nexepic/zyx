...
description: ZYX provides comprehensive configuration options to optimize performance and behavior for your specific workload.
...
- [Installation](/en/docs/zyx/contributing/installation) - Build and setup instructions
- [System Requirements](/en/docs/zyx/contributing/requirements) - Hardware and software requirements
- [Performance Optimization](/en/docs/zyx/architecture/optimization) - Advanced tuning guide
- [API Reference](/en/docs/zyx/api/cpp-api) - Programmatic configuration
