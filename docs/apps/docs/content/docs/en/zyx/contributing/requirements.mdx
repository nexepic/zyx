...
description: ZYX has specific requirements for building and running the database engine.
...
- [Installation](/en/docs/zyx/contributing/installation) - Build and install instructions
- [Configuration](/en/docs/zyx/contributing/configuration) - Runtime configuration options
- [Performance Optimization](/en/docs/zyx/architecture/optimization) - Tuning guidelines
