...
description: ZYX provides comprehensive error handling through exceptions and error codes. This guide covers error handling best practices and the complete error A
category: C++ API
order: 4
project: zyx
projectLabel: ZYX
...
- [Transaction Class](/en/docs/zyx/api/transaction) - Transaction error handling
- [Database Class](/en/docs/zyx/api/cpp-api) - Database error handling
- [Value Types](/en/docs/zyx/api/types) - Type-related errors
