---
title: 查询引擎
description: "ZYX 查询引擎通过三阶段流水线处理 Cypher 查询：解析器 → 规划器 → 执行器。"
category: 查询系统
order: 99
project: zyx
projectLabel: ZYX
...
- [事务管理](/zh/docs/zyx/architecture/transactions) - 事务管理
- [存储系统](/zh/docs/zyx/architecture/storage) - 数据存储方式
- [API 参考](/zh/docs/zyx/api/cpp-api) - 编程查询执行
