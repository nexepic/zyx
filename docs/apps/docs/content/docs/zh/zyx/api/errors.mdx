---
title: 错误处理
description: ZYX 通过异常和错误码提供全面的错误处理。本指南涵盖错误处理最佳实践和完整的错误 API。
category: C++ API
order: 4
project: zyx
projectLabel: ZYX
...
- [Transaction 类](/zh/docs/zyx/api/transaction) - 事务错误处理
- [Database 类](/zh/docs/zyx/api/cpp-api) - 数据库错误处理
- [值类型](/zh/docs/zyx/api/types) - 类型相关错误
