...
从 [GitHub Releases](https://github.com/nexepic/zyx/releases) 页面下载预构建的可执行文件。

### 从源码构建（可选）

详见 [安装指南](../contributing/installation)。
...
如果你更喜欢使用 Python，可以安装 `zyxdb` 包并以编程方式操作 ZYX：
...
:::tip
完整的 Python API 参考请查看 [Python API 参考](../api/python-api)。
:::
