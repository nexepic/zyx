...
| 步骤 | 文档 | 重点 |
|---|---|---|
| 1 | [特性概览](features) | ZYX 提供什么 — 存储、索引、向量检索、事务 |
| 2 | [快速开始](quick-start) | 安装 CLI、打开数据库、跑通首条查询 |
| 3 | [基本操作](basic-operations) | CRUD、索引、约束 |
| 4 | [Cypher 基础](cypher-basics) | 子句模型与表达式能力 |
| 5 | [模式匹配](pattern-matching) | 有向/无向与变长模式 |
| 6 | [高级查询](advanced-queries) | WITH/UNION/UNWIND/CALL/LOAD CSV |
| 7 | [事务控制](transactions) | 显式事务边界与回滚 |
| 8 | [批处理操作](batch-operations) | 大规模写入与导入策略 |
| 9 | [导入与导出](import-export) | 数据迁移与备份恢复 |
