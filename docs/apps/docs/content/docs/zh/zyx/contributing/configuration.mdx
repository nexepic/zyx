---
title: 系统配置
description: ZYX 提供全面的配置选项，可为您的特定工作负载优化性能和行为。
...
- [安装](/zh/docs/zyx/contributing/installation) - 构建和设置说明
- [系统要求](/zh/docs/zyx/contributing/requirements) - 硬件和软件要求
- [性能优化](/zh/docs/zyx/architecture/optimization) - 高级调优指南
- [API 参考](/zh/docs/zyx/api/cpp-api) - 编程配置
