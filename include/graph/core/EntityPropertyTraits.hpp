...
struct EntityPropertyTraits<Node> {
    ...
    static bool hasPropertyEntity(const Node& entity) {
        return entity.hasPropertyEntity();
    }
    ...
    static int64_t getPropertyEntityId(const Node& entity) {
        return entity.getPropertyEntityId();
    }
    ...
    static bool hasProperty(const Node& entity, const std::string& key) {
        return entity.hasProperty(key);
    }

    static void removeProperty(Node& entity, const std::string& key) {
    ...
    static void clearProperties(Node& entity) {
...
struct EntityPropertyTraits<Edge> {
    ...
    static bool hasPropertyEntity(const Edge& entity) {
        return entity.hasPropertyEntity();
    }
    ...
    static int64_t getPropertyEntityId(const Edge& entity) {
        return entity.getPropertyEntityId();
    }
    ...
    static bool hasProperty(const Edge& entity, const std::string& key) {
        return entity.hasProperty(key);
    }

    static void removeProperty(Edge& entity, const std::string& key) {
        entity.removeProperty(key);
    }
    ...
    static void clearProperties(Edge& entity) {
        entity.clearProperties();
    }
