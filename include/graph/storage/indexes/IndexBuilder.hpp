...
namespace graph::query::indexes {
	...
	public:
		 ...
		 */
		IndexBuilder(std::shared_ptr<IndexManager> indexManager, std::shared_ptr<storage::FileStorage> storage);
	...
	private:
		 ...
		 * @param propertyKey If not empty, only this property key will be indexed. Otherwise, all properties are
		 * indexed.
		 */
